...
/* enable to build with ESP-LWIP options
 * this prevents redefined warnings when building with standard LWIP
 */
#define ESP_LWIP_OPTS 0
...
#if CONFIG_LWIP_CHECK_THREAD_SAFETY
...
#else
#error "Do Not use LWIP pools, gives assert in multiple places"
 ...
 * TODO(ppp-idleflag): if PPP_MAXIDLEFLAG > 0 and next package is sent during PPP_MAXIDLEFLAG time,
 ...
 */
#if CONFIG_LWIP_TIMERS_ONDEMAND
 ...
 */
#if CONFIG_LWIP_ESP_GRATUITOUS_ARP
 ...
 */
#if CONFIG_LWIP_ESP_MLDV6_REPORT
