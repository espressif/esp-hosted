...
#define H_OT_UART_PIN_TX_TO_RCP CONFIG_ESP_HOSTED_OT_HOST_UART_TX_PIN_TO_RCP
#define H_OT_UART_PIN_RX_TO_RCP CONFIG_ESP_HOSTED_OT_HOST_UART_RX_PIN_TO_RCP
