...
typedef enum _CtrlMsgId {
  ...
  CTRL_MSG_ID__Req_WifiInit = 122,
  CTRL_MSG_ID__Req_WifiDeinit = 123,
  CTRL_MSG_ID__Req_WifiStart = 124,
  CTRL_MSG_ID__Req_WifiStop = 125,
  CTRL_MSG_ID__Req_WifiConnect = 126,
  CTRL_MSG_ID__Req_WifiDisconnect = 127,
  CTRL_MSG_ID__Req_WifiSetConfig = 128,
  CTRL_MSG_ID__Req_WifiGetConfig = 129,
  /*
   * Add new control path command response before Req_Max
   * and update Req_Max 
   */
  CTRL_MSG_ID__Req_Max = 130,
  /*
   ** Response Msgs *
   */
  ...
  CTRL_MSG_ID__Resp_WifiInit = 222,
  CTRL_MSG_ID__Resp_WifiDeinit = 223,
  CTRL_MSG_ID__Resp_WifiStart = 224,
  CTRL_MSG_ID__Resp_WifiStop = 225,
  CTRL_MSG_ID__Resp_WifiConnect = 226,
  CTRL_MSG_ID__Resp_WifiDisconnect = 227,
  CTRL_MSG_ID__Resp_WifiSetConfig = 228,
  CTRL_MSG_ID__Resp_WifiGetConfig = 229,
  /*
   * Add new control path command response before Resp_Max
   * and update Resp_Max 
   */
  CTRL_MSG_ID__Resp_Max = 230,
  /*
   ** Event Msgs *
   */
...
typedef enum {
  ...
  CTRL_MSG__PAYLOAD_REQ_WIFI_INIT = 122,
  CTRL_MSG__PAYLOAD_REQ_WIFI_DEINIT = 123,
  CTRL_MSG__PAYLOAD_REQ_WIFI_START = 124,
  CTRL_MSG__PAYLOAD_REQ_WIFI_STOP = 125,
  CTRL_MSG__PAYLOAD_REQ_WIFI_CONNECT = 126,
  CTRL_MSG__PAYLOAD_REQ_WIFI_DISCONNECT = 127,
  CTRL_MSG__PAYLOAD_REQ_WIFI_SET_CONFIG = 128,
  CTRL_MSG__PAYLOAD_REQ_WIFI_GET_CONFIG = 129,
  ...
  CTRL_MSG__PAYLOAD_RESP_WIFI_INIT = 222,
  CTRL_MSG__PAYLOAD_RESP_WIFI_DEINIT = 223,
  CTRL_MSG__PAYLOAD_RESP_WIFI_START = 224,
  CTRL_MSG__PAYLOAD_RESP_WIFI_STOP = 225,
  CTRL_MSG__PAYLOAD_RESP_WIFI_CONNECT = 226,
  CTRL_MSG__PAYLOAD_RESP_WIFI_DISCONNECT = 227,
  CTRL_MSG__PAYLOAD_RESP_WIFI_SET_CONFIG = 228,
  CTRL_MSG__PAYLOAD_RESP_WIFI_GET_CONFIG = 229,
