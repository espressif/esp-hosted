...
/* 11 */  unsigned int (*_h_sleep)(unsigned int seconds);
          ...
          /* Queue */
/* 12 */  int    (*_h_queue_item)(void * queue_handle, void *item, int timeout);
/* 13 */  void*  (*_h_create_queue)(uint32_t qnum_elem, uint32_t qitem_size);
/* 14 */  int    (*_h_dequeue_item)(void * queue_handle, void *item, int timeout);
/* 15 */  int    (*_h_destroy_queue)(void * queue_handle);
/* 16 */  int    (*_h_reset_queue)(void * queue_handle);

          /* Mutex */
/* 17 */  int    (*_h_unlock_mutex)(void * mutex_handle);
/* 18 */  void*  (*_h_create_mutex)(void);
/* 19 */  int    (*_h_lock_mutex)(void * mutex_handle, int timeout);
/* 20 */  int    (*_h_destroy_mutex)(void * mutex_handle);

          /* Semaphore */
/* 21 */  int    (*_h_post_semaphore)(void * semaphore_handle);
/* 22 */  int    (*_h_post_semaphore_from_isr)(void * semaphore_handle);
/* 23 */  void*  (*_h_create_binary_semaphore)(void);
/* 24 */  int    (*_h_get_semaphore)(void * semaphore_handle, int timeout);
/* 25 */  int    (*_h_destroy_semaphore)(void * semaphore_handle);

          /* Spinlock */
/* 26 */  void*  (*_h_create_spinlock)(void);

          /* Timer */
/* 27 */  int    (*_h_timer_stop)(void *timer_handle);
/* 28 */  void*  (*_h_timer_start)(int duration, int type, void (*timeout_handler)(void *), void *arg);

          /* Critical section */
/* 29 */  void   (*_h_enter_critical)(void *spinlock_handle);
/* 30 */  void   (*_h_exit_critical)(void *spinlock_handle);

          /* GPIO */
/* 31 */ int (*_h_config_gpio)(uint32_t gpio_port, uint32_t gpio_num);
/* 32 */ int (*_h_config_gpio_as_interrupt)(uint32_t gpio_port, uint32_t gpio_num, uint32_t intr_type, void (*gpio_isr_handler)(void* arg));
/* 33 */ int (*_h_read_gpio)(uint32_t gpio_port, uint32_t gpio_num);
/* 34 */ int (*_h_write_gpio)(uint32_t gpio_port, uint32_t gpio_num, uint32_t value);

          /* Trasport - SPI */
/* 35 */ void * (*_h_bus_init)(void (*gpio_hs_dr_isr_handler)(void* arg));
/* 36 */ int (*_h_do_bus_transfer)(void *transfer_context);
