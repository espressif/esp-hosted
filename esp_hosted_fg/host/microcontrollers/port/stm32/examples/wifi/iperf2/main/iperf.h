...
#define RUN_IPERF_SERVER 0
#define RUN_IPERF_CLIENT 1

#define RUN_IPERF_UDP 0
#define RUN_IPERF_TCP 1


#if (RUN_IPERF_CLIENT) != (!RUN_IPERF_SERVER)
#error "Either client or server could be configured"
#endif
#if (RUN_IPERF_TCP) != (!RUN_IPERF_UDP)
#error "Either TCP or UDP could be configured"
#endif
