...
/* eh_common_header.h — V1 wire header (12 bytes). See eh_common_header_v2.h for V2. */

/* Define to debug drops / out-of-seq packets. */
...
#define EH_ESP_PAYLOAD_HEADER_OFFSET              sizeof(struct esp_payload_header)
