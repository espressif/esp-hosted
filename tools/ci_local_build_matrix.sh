...
CELLS=(
  ...
  "release-v5.5|examples/bluetooth/nimble_hosted_hci/bleprph_gatt/cp|esp32c6|"
  "latest|examples/bluetooth/nimble_standard_hci/bleprph_host_only_uart/cp|esp32|"
  ...
  "latest|examples/bluetooth/nimble_hosted_hci/bleprph_wifi_coex/mcu_host|esp32p4|"
  "release-v5.5|examples/bluetooth/nimble_standard_hci/bleprph_host_only_uart/mcu_host|esp32h2|"
