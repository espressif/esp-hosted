...
CELLS=(
  ...
  "release-v5.5|examples/bluetooth/cp/hosted_hci|esp32c6|"
  "latest|examples/bluetooth/cp/standard_hci_uart|esp32|"
  ...
  "latest|examples/bluetooth/host_mcu/nimble/examples/hosted_hci/bleprph_wifi_coex|esp32p4|"
  "release-v5.5|examples/bluetooth/host_mcu/nimble/examples/standard_hci_uart/bleprph_host_only_uart|esp32h2|"
