...
The build system automatically pulls in the correct components based on your example choice:
...
No manual component configuration is needed - just choose the right example for your host type!
