...
```c
// ESP_ERROR_CHECK(esp_hosted_ext_rpc_mcu_init());
```

This disables the MCU RPC extension, leaving only the core coprocessor functionality and transport layer active.
