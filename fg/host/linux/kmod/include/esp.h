...
struct esp_adapter {
	...
	atomic_t                state;
	u32                     capabilities;
	u32                     feat_caps[8];  /* ESP_PRIV_FEAT_CAPS (0x19) — 256-bit feature bitmask */
	u8                      hdr_ver_negotiated; /* agreed wire-header version: 1=V1, 2=V2 */
	u8                      rpc_ver_negotiated; /* agreed RPC version: 1=V1 variant, 2=V2 unified */
