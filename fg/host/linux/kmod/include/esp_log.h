...
#define ESP_LOGE(tag, format, ...) esp_err(format, ##__VA_ARGS__)
#define ESP_LOGW(tag, format, ...) esp_warn(format, ##__VA_ARGS__)

#ifdef CONFIG_INFO_LOGS
#define esp_info pr_info
#define ESP_LOGI(tag, format, ...) esp_info(format, ##__VA_ARGS__)
#else
...
#define ESP_LOGD(tag, format, ...) esp_dbg(format, ##__VA_ARGS__)
#else
...
#define ESP_LOGV(tag, format, ...) esp_verbose(format, ##__VA_ARGS__)
#else
