...
static int demo1_peer_data_transfer_dog_sound(void);
static int demo2_peer_data_transfer_cat_sound(void);
static int demo3_peer_data_transfer_bird_sound(void);
...
static int parse_cli_cmd(char *in_cmd, char *args[])
{
	...
	EXEC_IF_CMD_EQUALS(CUSTOM_RPC_DEMO1, demo1_peer_data_transfer_dog_sound());
	EXEC_IF_CMD_EQUALS(CUSTOM_RPC_DEMO2, demo2_peer_data_transfer_cat_sound());
	EXEC_IF_CMD_EQUALS(CUSTOM_RPC_DEMO3, demo3_peer_data_transfer_bird_sound());
...
/* ------------------- Peer Data Transfer DEMO 1 ------------------- */
/* Send a dog sound to the CP; CP replies with "Woof! (from CP)"       */
static int demo1_peer_data_transfer_dog_sound(void) {
	return peer_data_transfer_demo1_dog_sound();
}

/* ------------------- Peer Data Transfer DEMO 2 ------------------- */
/* Send a cat sound to the CP; CP replies with "Meow! (from CP)"       */
static int demo2_peer_data_transfer_cat_sound(void) {
	return peer_data_transfer_demo2_cat_sound();
}

/* ------------------- Peer Data Transfer DEMO 3 ------------------- */
/* Send a bird sound to the CP; CP replies with "Tweet! (from CP)"     */
static int demo3_peer_data_transfer_bird_sound(void) {
	return peer_data_transfer_demo3_bird_sound();
}
