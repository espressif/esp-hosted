...
try:
    commands_lib = cdll.LoadLibrary("libesp_hosted_rpc.so")
except OSError as e:
    print(f"Error loading libesp_hosted_rpc.so: {e}")
    print("Make sure LD_LIBRARY_PATH includes the library directory, or run ./py_app_build.sh script.")
