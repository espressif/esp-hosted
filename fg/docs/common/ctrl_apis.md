...
- This document describes C API's provided for control path interface. Please refer [ctrl_api.h](../../host/components/esp_hosted_rpc_lib/include/ctrl_api.h) for API definition
...
- A [stress.c](../../host/linux/user_space/c_demo_app/stress.c) can use for stress testing of control path commands. In which, `stress_test_count` variable represents the number of iterations the stress test should run for given configurations
