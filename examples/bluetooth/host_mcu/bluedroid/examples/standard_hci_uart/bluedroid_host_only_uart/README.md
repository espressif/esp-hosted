...
This example is modified based on [classic_bt_discovery](../../hosted_hci/classic_bt_discovery), and all modifications are listed below:
...
This example should be able to run on any commonly available ESP development board. To connect UART to another board running a Bluetooth controller. For example, the [standard_hci_uart CP firmware](../../../../../cp/standard_hci_uart).
