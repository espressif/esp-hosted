...
class ctrl_cmd(object):
    ...
    def connect_ap(self, ssid : str = "", pwd : str = "", bssid : str = "", use_wpa3 : bool = False, listen_interval : int = 3, set_dhcp : bool = True):
        """Connect to AP (WiFi router or hotspot)

        Args:
            ssid (str, mandatory): M | SSID of AP (WiFi router)
            pwd(str, optional): O | Password of AP (WiFi router) to connect to
    ...
    def get_connected_ap_info(self):
        """Get info of connected AP (WiFi router or hotspot)
    ...
    def disconnect_ap(self, reset_dhcp : bool = True):
        """Disconnect from AP (WiFi router or hotspot)
    ...
    def softap_vendor_ie(self, enable : bool = "True", data: str = ""):
        ...
        Args:
            ...
            data(bool, optional): O | String to set in softap WiFi broadcast beacon | Default: ''
    ...
    def start_softap(self, ssid : str = "", pwd : str = "", channel : int = 1, sec_prot: str = "wpa_wpa2_psk", max_conn: int = 4, hide_ssid: bool = False, bw : int = 20):
        ...
        Args:
            ...
            channel(int, optional): O | WiFi channel [ 1 to 11] | Default: 1
            ...
            bw(int, optional): O | WiFi Bandwidth [ 20 | 40 ] | Default: 20
