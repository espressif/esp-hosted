...
struct esp_adapter {
	...
	atomic_t                state;
	u32                     capabilities;
	u32                     capabilities_ext;	/* MCU V1 TLV 0x16 */
	u32                     fw_version;		/* MCU V1 TLV 0x17 (EH_VERSION_VAL) */
	u8                      chip_id;		/* MCU V1 TLV 0x12 */
	bool                    peer_advertised_rpc_version;	/* CP sent EH_PRIV_RPC_VERSION (0x1A) in caps */
