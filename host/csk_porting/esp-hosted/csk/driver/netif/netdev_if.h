...
struct netdev_ops {
	...
	/* Transmit packet */
	int (* netdev_xmit) (netdev_handle_t netdev, struct net_pbuf *net_buf);
};
 ...
 * @param netdev - Network device instance
 * @param net_pbuf - received data buffer
 */
int netdev_rx(netdev_handle_t netdev, struct net_pbuf *net_buf);
