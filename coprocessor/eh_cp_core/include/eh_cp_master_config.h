...
#ifdef CONFIG_ESP_HOSTED_CP_FEAT_HOST_PS_WAKE_HOST_ON_CP_BOOT
#  define EH_CP_FEAT_HOST_PS_WAKE_HOST_ON_CP_BOOT  1
#else
#  define EH_CP_FEAT_HOST_PS_WAKE_HOST_ON_CP_BOOT  0
#endif
