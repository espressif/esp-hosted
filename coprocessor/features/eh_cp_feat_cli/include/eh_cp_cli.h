...
/**
 * @brief Stop the running CLI console instance
 *
 * Stops the REPL and releases the console handle so the underlying UART/USB
 * can be powered down (e.g. before light sleep with peripheral power-down).
 * Safe to call when CLI is not started.
 */
