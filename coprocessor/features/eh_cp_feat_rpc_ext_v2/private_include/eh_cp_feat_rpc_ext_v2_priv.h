...
/* Internal functions - these exist in eh_cp_feat_rpc_ext_v2_rpc_dispatcher_*.c */
esp_err_t eh_cp_feat_rpc_ext_v2_rpc_evt_dispatcher(Rpc *ntfy, void *priv_data, const uint8_t *inbuf, size_t inlen);
esp_err_t eh_cp_feat_rpc_ext_v2_rpc_req_dispatcher(Rpc *req, Rpc *resp, void *priv_data);

/* System RPC Request Handlers - these exist in eh_cp_feat_rpc_ext_v2_rpc_handler_req_system.c */
...
/* WiFi RPC Request Handlers - Core Functions (exist in eh_cp_feat_rpc_ext_v2_rpc_handler_req_wifi.c) */
...
#if EH_CP_FEAT_CP_EXT_COEX_READY
