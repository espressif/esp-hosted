...
static const char* TAG = "rpc_linux_802_3_req";

/* Unknown/disabled IDs return CTRL_MSG_ID__Resp_Base — host treats as unsupported. */
esp_err_t eh_cp_feat_rpc_ext_v1_rpc_req_dispatcher(
