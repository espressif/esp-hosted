...
static const char* TAG = "rpc_linux_802_3_protocomm";
                                 ...
                                 uint8_t **outbuf, ssize_t *outlen, void *priv_data)
{
     ...
     ret = eh_cp_feat_rpc_ext_v1_rpc_req_dispatcher(req, &resp, NULL);
     if (ret) {
                                   ...
                                   uint8_t **outbuf, ssize_t *outlen, void *priv_data)
{
     ...
     ret = eh_cp_feat_rpc_ext_v1_rpc_evt_dispatcher(&ntfy, NULL, inbuf, inlen);
     if (ret) {
